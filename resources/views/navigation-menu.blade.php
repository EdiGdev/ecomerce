        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-jet-nav-link href="{{ route('admin.payments.show') }}" :active="request()->routeIs('admin.payments.*')">
                        Pagos
                    </x-jet-nav-link>
                    <x-jet-nav-link href="{{ route('admin.banners.show') }}" :active="request()->routeIs('admin.banners.*')">
                        Banners
                    </x-jet-nav-link>
                    <x-jet-nav-link href="{{ route('admin.perfil_myg.show') }}" :active="request()->routeIs('admin.perfil_myg.*')">
                        Perfil M & G
                    </x-jet-nav-link>
