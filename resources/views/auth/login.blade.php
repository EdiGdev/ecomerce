        ...
        <div class="sm:py-12">
            <div class="flex max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-lg lg:max-w-4xl">
                <div class="hidden bg-cover lg:block lg:w-1/2"
                    style="background-image:url('/img/login.svg')"></div>
                ...
                <div class="w-full min-h-screen sm:min-h-0 px-6 py-8 md:px-8 lg:w-1/2">
                    ...
                    <a href="/auth/facebook" class="flex items-center justify-center mt-4 text-gray-600 border rounded-lg">
                        <div class="px-4 py-2">
                        ...
                        <span class="w-5/6 px-4 py-3 font-bold text-center">Inicia sesión con Facebook</span>
                    </a>
                    ...
                    <div class="flex items-center justify-between mt-4">
                        ...
                        <a href="#"
                            class="text-xs text-center text-gray-500 uppercase dark:text-gray-400 hover:underline">O
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="mt-4">
                            ...
                            <input
                                ...
                                name="email" value="" type="email" id="LoggingEmailAddress">
                        </div>
                            ...
                            @if (Route::has('password.request'))
                                <div class="flex justify-between">
                                    ...
                                    <a href="{{ route('password.request') }}"
                                        class="text-xs text-gray-500 hover:underline">¿Olvidaste tu contraseña?</a>
                                </div>
                            @endif

                            <input
                                class="border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm w-full"
                                name="password" type="password" id="loggingPassword">
                        </div>
                    ...
                    <div class="flex items-center justify-between mt-4">
                        ...
                        <a href="{{ route('register') }}"
                            class="text-xs text-center text-gray-500 uppercase dark:text-gray-400 hover:underline">¿No
