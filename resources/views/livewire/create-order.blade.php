    ...
    <div class="order-2 lg:order-1 lg:col-span-1 xl:col-span-3">
        ...
        <div x-data="{ envio_type: @entangle('envio_type') }">
            ...
            <label class="bg-white rounded-lg shadow px-6 py-4 flex items-center mb-4">
                ...
                <span class="ml-2 text-gray-700">Recojo en tienda ({{ $tienda->direccion_tienda }})</span>
        ...
        <div>
            ...
            <p class="text-sm text-gray-700 mt-2">
                Continúa con tu compra y disfruta de una experiencia única. En Merca y Gana, nos comprometemos a
                brindarte productos de calidad y un servicio excepcional. Si tienes alguna pregunta o inquietud durante
                el proceso de compra, nuestro equipo de soporte está aquí para ayudarte.

                Para obtener más información sobre nuestras políticas y privacidad, consulta nuestras
                <a href="{{ route('terminosycondiciones') }}" class="font-semibold text-blue-500">Políticas y privacidad</a>.
            </p>
            ...
            <div class="bg-white rounded-lg shadow p-6">
                    ...
                    @forelse(Cart::content() as $item)
                        <li class="flex p-2 border-b border-gray-200">
                            ...
                            <article class="flex-1">
                                ...
                                <p> $ {{ number_format(floor($item->price), 0, ',', '.') }} </p>
                            </article>
                        </li>
                    @empty
                        <li class="py-6 px-4">
                ...
                <div class="text-gray-700">
                    ...
                    <p class="flex justify-between items-center font-semibold">
                        ...
                        @else
                            $
                            {{ number_format(floor((float) str_replace(',', '', Cart::subtotal()) + $shipping_cost), 0, ',', '.') }}
                        @endif
                    </p>
