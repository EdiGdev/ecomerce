<div>
    ...
    <div class=" flex">
        ...
        <div class="flex-1">
            ...
            <form wire:submit.prevent="store">
                ...
                <div class="text-white px-4 py-2 rounded-md flex justify-end">
                    <x-jet-button class="">
                        Comentar
                    </x-jet-button>
    ...
    <p class=" text-lg font-semibold  mb-4">
        ...
        <button class="ml-3" x-on:click="sort = sort == 'asc' ? 'desc' : 'asc'">
            <i class="fas"
                :class="{
            ...
            <li wire:key="question-{{ $question->id }}">{{-- Con esto Livewire sabe que item tiene que actualizar o eliminar --}}
                ...
                <div class=" flex">
                    ...
                    <div class="flex-1">
                        ...
                        @else
                            {{-- Sino muestrame el comentario del usuario --}}
                            <p>
    ...
    @if ($model->questions()->count() - $cant > 0)
        {{-- Solo se mostrara el boton si esta operacion es mayor a cero --}}
        <div class=" flex items-center">

            <hr class=" flex-1">

            <button wire:click='show_more_questions'
                class=" mx-4 font-semibold text-sm text-gray-500 hover:text-gray-600 ">
