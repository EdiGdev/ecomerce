<div class=" pl-16">
    ...
    <button x-on:click="add_reaction(1, $answer->id)" wire:loading.attr="disabled">
        <i class="far fa-thumbs-up" x-bind:class="value == 'like' ? 'text-blue-600' : ''"></i>
        <span x-text="likes_count"></span>
    </button>

    <button x-on:click="add_reaction(2, $answer->id)" wire:loading.attr="disabled" class="mx-2">
        <i class="far fa-thumbs-down" x-bind:class="value == 'dislike' ? 'text-red-500' : ''"></i>
        <span x-text="dislikes_count"></span>
    </button>
